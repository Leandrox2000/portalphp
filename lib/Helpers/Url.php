...
/**
 * Gerador de slug baseado nas funções do Wordpress.
 * https://core.trac.wordpress.org/browser/tags/3.9.2/src/wp-includes/formatting.php
 */
class Url {
    ...
    public static function generateRoute($controller, $action = null, $entity = null)
    {
        if ($entity) {
            return $controller . '/' . $action . '/' . $entity->getId();
        } else {
            if ($action) {
