(function(a) {
    a.fn.smartWizard = function(k) {
        var c = a.extend({}, a.fn.smartWizard.defaults, k), u = arguments;
        return this.each(function() {
            ...
            function q(d) {
                ...
                stepNum = d + 1;
                g && g.length > 0 ? c.contentCache && h ? t(d) : a.ajax({url: g, type: "POST", data: {step_number: stepNum}, dataType: "text", beforeSend: function() {
                        l.show()
                    }, error: function() {
                        l.hide()
                    }, success: function(c) {
            ...
            function t(d) {
                ...
                if (d != h && a.isFunction(c.onLeaveStep) && !c.onLeaveStep.call(this, a(g), a(e)))
                    return!1;
...
//                        b).outerHeight());
                ...
                if (c.transitionEffect == "slide")
                    ...
                    d == h ? (nextElmLeft1 = a(a(e, b).attr("href"), b).outerWidth() + 20, nextElmLeft2 = 0, i = 0 - a(a(g, b).attr("href"), b).outerWidth()) : a(a(g, b).attr("href"), b).animate({left: i}, "fast", function() {
                    ...
                    a(a(g, b).attr("href"), b).hide(), a(a(e, b).attr("href"), b).show(), h = d, r(g, e);
                return!0
            }
            function r(d, e) {
    ...
    a.fn.smartWizard.defaults = {selected: 0, keyNavigation: !0, enableAllSteps: !1, transitionEffect: "fade", contentURL: null, contentCache: !0, cycleSteps: !1, enableFinishButton: !1,
        errorSteps: [], labelNext: "Próximo", labelPrevious: "Anterior", labelFinish: "Finalizar", onLeaveStep: null, onShowStep: null, onFinish: null}
})(jQuery);