 ...
 */
class ComentarioNoticia extends BaseService
{

    /**
     * 
     * @param \Doctrine\ORM\EntityManager $em
     * @param \Entity\ComentarioNoticia $entity
     */
    public function __construct(EntityManager $em, ComentarioEntity $entity, Session $session)
    {
