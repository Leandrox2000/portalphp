...
use Entity\CategoriaLegislacao as CategoriaLegislacaoEntity;
use Helpers\Session;

/**
 * Description of CategoriaLegislacao
 *
 * @author Join-ti
 */
class CategoriaLegislacao extends BaseService
{
     ...
     */
    public function __construct(\Doctrine\ORM\EntityManager $em, CategoriaLegislacaoEntity $entity, Session $session)
    {
